...
try {
  $new = $conn->prepare("INSERT INTO docubase (visible, featured, tr_title, en_title, city, county, village, county_old_name, village_old_name, story_type, tr_story, en_story, lat, lon, url)
  VALUES (:visible, :featured, :tr_title, :en_title, :city, :county, :village, :county_old_name, :village_old_name, :story_type, :tr_story, :en_story, :lat, :lon, :url)");
  ...
  $conn = null;
?>
<h1>Hikâye başarıyla kaydedildi</h1>
</div><div>
